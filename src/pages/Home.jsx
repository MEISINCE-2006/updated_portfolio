...
export default function Home() {
  return (
    <section id="home" className="page flex flex-col items-center justify-center pt-32 min-h-screen">
      ...
      >
        A Final Year student who aspires to become a <span className="text-primary font-semibold">Java Developer & MERN Stack Engineer</span> with a strong focus on Full Stack Web Development and creative software solutions. Skilled in Java, OOP concepts, and scalable application architecture to deliver meaningful development projects.
      </motion.p>
